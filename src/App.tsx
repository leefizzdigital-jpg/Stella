...
export default function App() {
  ...
  return (
    <div className="relative h-svh w-full overflow-hidden bg-black font-sans text-white sm:max-w-md sm:mx-auto sm:border-x sm:border-white/10 sm:shadow-2xl sm:shadow-purple-900/20">
      {/* Background with parallax effect or static based on scene */}
